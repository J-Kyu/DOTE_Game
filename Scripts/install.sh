...
UNITY_OSX_PACKAGE_URL="https://download.unity3d.com/download_unity/46dda1414e51/MacEditorInstaller/Unity-2018.2.19f1.pkg"
UNITY_WINDOWS_TARGET_PACKAGE_URL="https://beta.unity3d.com/download/46dda1414e51/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2018.2.19f1.pkg"
...
download() {
	...
	if [ ! -e $UNITY_DOWNLOAD_CACHE/`basename "$URL"` ] ; then
		...
		curl -o $UNITY_DOWNLOADc_CACHE/`basename "$URL"` "$URL"
	else
